(function () {
    ...
    var selector = "[data-avdctai-project-bridge='1']";
    ...
    function sendSeen(element) {
        if (!element || element.getAttribute("data-avdctai-bridge-seen") === "1") {
            return;
        }

        element.setAttribute("data-avdctai-bridge-seen", "1");

        var form = new FormData();
        form.append("action", config.action);
        form.append("nonce", config.nonce);
        form.append("type", "project_bridge_seen");
        form.append("source", element.getAttribute("data-avdctai-placement") || "project_bridge");
        ...
        form.append("label", element.getAttribute("data-avdctai-project-name") || "Project Bridge");
